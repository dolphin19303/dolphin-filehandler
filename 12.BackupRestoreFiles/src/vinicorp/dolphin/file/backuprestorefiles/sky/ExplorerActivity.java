...
public class ExplorerActivity extends Activity {
	...
	private static final String[] HTTP_METHODS = { "GET", "DELETE", "PUT",
			"POST" };
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
				android.R.layout.simple_spinner_item, HTTP_METHODS);
					...
					public void onItemSelected(AdapterView<?> parent,
						...
						default: {
							makeToast("Unknown HTTP method selected: "
									+ httpMethodSpinner.getSelectedItem()
											.toString());
							break;
						}
						}
		...
		findViewById(R.id.submitButton).setOnClickListener(
				new OnClickListener() {
					...
					public void onClick(View v) {
						...
						String bodyString = mRequestBodyText.getText()
								.toString();
						...
						int selectedPosition = httpMethodSpinner
								.getSelectedItemPosition();
						boolean httpMethodRequiresBody = selectedPosition == POST
								|| selectedPosition == PUT;
						if (httpMethodRequiresBody
								&& TextUtils.isEmpty(bodyString)) {
						...
						case DELETE: {
							mConnectClient
									.deleteAsync(path, mOperationListener);
							break;
						}
						case POST: {
							mConnectClient.postAsync(path, bodyString,
									mOperationListener);
							break;
						}
						case PUT: {
							mConnectClient.putAsync(path, bodyString,
									mOperationListener);
							break;
						}
						default: {
